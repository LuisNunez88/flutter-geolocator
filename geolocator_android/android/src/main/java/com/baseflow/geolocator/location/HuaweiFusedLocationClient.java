...
class HuaweiFusedLocationClient implements LocationClient {
  ...
  public HuaweiFusedLocationClient(@NonNull Context context, @Nullable LocationOptions locationOptions) {
              ...
              if (response.isSuccessful()) {
                ...
                if (lsr != null) {
                  ...
                  listener.onLocationServiceResult(
                      settingsStates.isGnssUsable() || settingsStates.isNetworkLocationUsable());
                } else {
